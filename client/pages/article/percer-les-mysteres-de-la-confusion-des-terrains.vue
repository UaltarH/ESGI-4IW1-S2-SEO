...
const article: Article = articles.find((article) => article.url === '/article/percer-les-mysteres-de-la-confusion-des-terrains');
const options = {
  year: 'numeric',
  month: 'long',
  day: 'numeric',
...
const description = 'Percer les mystères de la confusion des terrains : Relever le défi des paysages incertains';
useSeoMeta({
  title: article.title,
