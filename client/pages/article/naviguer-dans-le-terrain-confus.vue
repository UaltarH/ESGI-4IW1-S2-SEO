...
const article: Article = articles.find((article) => article.url === '/article/naviguer-dans-le-terrain-confus');
const options = {
  year: 'numeric',
  month: 'long',
  day: 'numeric',
...
const description = 'Conseils pour s\'orienter dans des environnements incertains';
useSeoMeta({
  title: article.title,
